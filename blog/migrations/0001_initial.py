# Generated by Django 2.0.7 on 2019-01-11 16:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ordered_from', models.CharField(blank=True, max_length=200, null=True)),
                ...
                ('date_due', models.CharField(blank=True, max_length=50, null=True)),
                ('surveyor', models.CharField(blank=True, max_length=50, null=True)),
                ('field_crew', models.CharField(blank=True, max_length=200, null=True)),
                ...
                ('delete_later', models.CharField(blank=True, max_length=50, null=True)),
            ],
            options={
                'db_table': 'amarillo',
            },
